...
import { ScaleUpVariant } from "../../animationVariants/ScaleUpVariant";
...
const HomeLeft = () => {
  ...
  const IconsInView = useInView(IconRef);
  const TextAnimationControl = useAnimation();
  const IconAnimationControl = useAnimation();
  ...
  useEffect(() => {
    ...
    if (IconsInView) {
      IconAnimationControl.start("visible");
    }
  }, [textInView, TextAnimationControl, IconsInView, IconAnimationControl]);
  return (
    <div className="flex flex-col gap-8">
      ...
      >
        <h2 className="font-bold text-8xl drop-shadow-textShadow ">$pepe</h2>
        <p className="text-3xl font-normal tracking-wide ">
          the most memeable memecoin in existence. The dogs have had their day,
          it’s time for Pepe to take reign.
        </p>
      </motion.div>

      <div className="flex gap-4 items-center" ref={IconRef}>
        {/* twitter */}
        <Link to={"/"} className="hover:scale-110 duration-300 cursor-pointer">
          <motion.svg
